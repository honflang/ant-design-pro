export default {
  ...
  'menu.pricing.rules': 'Pricing Rules',
  'menu.pricing.simulation': 'Pricing Simulation',
  'menu.pricing.approval': 'Approval Center',
  'menu.billing': 'Billing Management',
  'menu.billing.configuration': 'Billing Configuration',
  'menu.billing.run': 'Billing Run',
  'menu.billing.invoice': 'Invoice Management',
  'menu.performance': 'Performance Management',
  'menu.performance.revenue': 'Revenue Tracking',
  'menu.performance.deal': 'Deal Performance',
  'menu.customer': 'Customer Management',
  'menu.customer.360': 'Customer 360',
  'menu.customer.portfolio': 'Customer Portfolio',
  'menu.customer.deal-pricing-request': 'Deal Pricing Request',
