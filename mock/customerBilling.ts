type ChargeEvent = {
  ...
  tender_accounts?: number;
  outstanding_entrustment_loan_amount?: number;
...
const chargeEvents: ChargeEvent[] = [
  { id: 'CHG-20260115-001', event_type: 'CASH_POOL_CREATE', event_time: '2026-01-15T09:30:00+08:00', customer_id: 'CUST_12345', service_code: 'FCY_DOMESTIC_CASH_POOL', tariff_item_no: 'TARIFF-001', tariff_item_name: 'Setup Fee', group_number: 3, total_active_account_count: 4, tender_accounts: 2, outstanding_entrustment_loan_amount: 0, currency: 'SGD', amount: 1800 },
  { id: 'CHG-20260701-001', event_type: 'CASH_POOL_MONTHLY_MAINT', event_time: '2026-07-01T02:00:00+08:00', customer_id: 'CUST_12345', service_code: 'FCY_DOMESTIC_CASH_POOL', tariff_item_no: 'TARIFF-002', tariff_item_name: 'Monthly Maintenance Fee', group_number: 3, total_active_account_count: 4, tender_accounts: 2, outstanding_entrustment_loan_amount: 0, currency: 'SGD', amount: 420 },
  { id: 'CHG-20260701-002', event_type: 'CASH_POOL_COMMISSION', event_time: '2026-07-01T02:00:00+08:00', customer_id: 'CUST_12345', service_code: 'FCY_DOMESTIC_CASH_POOL', tariff_item_no: 'TARIFF-003', tariff_item_name: 'Commission Fee', group_number: 3, total_active_account_count: 4, tender_accounts: 2, outstanding_entrustment_loan_amount: 0, currency: 'SGD', amount: 1260 },
...
export default {
  'GET /api/customer/charge-details': (_req: unknown, res: { json: (body: unknown) => void }) => {
    res.json({ data: chargeEvents, total: chargeEvents.length, success: true });
  },
  'GET /api/customer/bill-details': (_req: unknown, res: { json: (body: unknown) => void }) => {
    res.json({ data: billDetails, total: billDetails.length, success: true });
  },
};